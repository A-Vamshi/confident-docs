...
Since the thread ID is something **you provide** ([click here](/docs/llm-tracing/features/threads) if unsure) during LLM tracing, it is generally easier to setup feedback collection on threads than on traces and spans.
...
import { observe, getCurrentTrace } from "deepeval/tracing";
...
import { OpenAI } from "openai";
import { observe, getCurrentSpan } from "deepeval/tracing";
