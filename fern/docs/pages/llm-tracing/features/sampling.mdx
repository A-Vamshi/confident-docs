...
slug: llm-tracing/features/sampling
---
...
<Info>
  This is useful for high-volume applications where you may want to reduce the
  amount of data being sent while still maintaining visibility into your
...
<Note>Traces are sampled at random and the rest are dropped</Note>
