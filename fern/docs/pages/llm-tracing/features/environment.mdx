...
slug: llm-tracing/features/environment
---
...
<Tip>
  Traces from [component-level
  evals](/docs/llm-evaluation/single-turn/component-level) are automatically
  classified in the `"testing"` enviornment.
</Tip>
