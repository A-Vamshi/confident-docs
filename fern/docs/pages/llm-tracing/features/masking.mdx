---
subtitle: Protect your sensitive information from traces using the masking feature
slug: llm-tracing/features/masking
---
...
<Tabs>
    ...
    <Tab title="TypeScript" language="typescript">
            ...
            const observedAgent = observe({ type: "agent", fn: agent });
...
<Note>
  Since the masking function is applied to an observed function's inputs,
  outputs, and span attributes, it must handle the various data types defined
  for each field as necessary.
</Note>
