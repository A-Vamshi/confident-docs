...
import { DeepEvalCallbackHandler } from "deepeval/integrations";
...
If your LangChain application is in production, and you still want to run evaluations on your traces, use [online evals](/docs/llm-tracing/online-evals). It lets you run evaluations on all incoming traces on Confident AI's server.
