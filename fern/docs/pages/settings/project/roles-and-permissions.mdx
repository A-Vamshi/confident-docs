...
Preset roles include all project permissions except the following:

- **Owner** — Includes everything (no exclusions).
- **Manager** — Includes everything (no exclusions).
- **Member** — Includes everything except `project:delete`, `user:manage`, and `iam:manage`. Members cannot delete the project, manage project members (invite, change roles, remove), or manage roles and policies.
